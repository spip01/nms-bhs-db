        ...
        <div id="pnl-user">
            <div class="row">
                <div class="col-lg-4 col-md-6 col-sm-7 col-14">
                    <div class="row">
                        <div class=" col-lg-14 col-5 txt-inp-def">Player Name<span id="namereq" class="h5 text-danger">&nbsp;*</span></div>
    ...
    const panel = `
        <div id="idname" class="card">
            ...
            <div class="card-body">
                <div id="id-addrInput">
                    <div class="row">
                        <div class="col-sm-4 col-5 txt-inp-def">Coords<span class="h5 text-danger">&nbsp;*</span>&nbsp;
                            <i class="fa fa-question-circle-o text-danger h6" data-toggle="tooltip" data-html="true"
                    ...
                    <div class="row">
                        <div class="col-lg-2 col-md-3 col-sm-2 col-4 txt-inp-def">Glyphs&nbsp;</div>
                ...
                <div id="id-glyphInput" class="hidden">
                    <div class="row">
                        <div class="col-lg-3 col-md-5 col-sm-3 col-5 txt-inp-def">
                ...
                <div class="row">
                    <div class="col-sm-4 col-7  txt-inp-def">System Name<span class="h5 text-danger">&nbsp;*</span>&nbsp;</div>
                    <input id="id-sys" class="rounded col-sm-5 col-7">
                </div>

                <div class="row">
                    <div class="col-sm-4 col-7 txt-inp-def">Region Name<span class="h5 text-danger">&nbsp;*</span>&nbsp;</div>
                ...
                <div id="row-by" class="row">
                    <div class="col-sm-4 col-7  txt-inp-def">Entered by&nbsp;</div>
                ...
                <!--div id="row-valid" class="row border-bottom">
                    <label class="radio col-5 txt-inp-def">
                    ...
                    <label class="radio col-4 txt-inp-def">
                ...
                <div class="row border-top">
                    ...
                    <label id="id-sharepoi" class="col-7 txt-inp-def hidden">
                ...
                <div id="id-isbase" class="row" style="display:none">
                    <div class="col-sm-3 col-4 txt-inp-def">Name</div>
