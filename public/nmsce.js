...
const wingAreaMap = `
    <div id="map-fighter-wings">
        ...
        <img class="map-image" src="images/fighter/wings/grey.jpg" style="position:absolute; z-index:1" />
        <img src="images/fighter/wings/blank.png" usemap="#fighter-wings-map" style="position:absolute; z-index:4" />
...
NMSCE.prototype.selectSublist = function (btn) {
    ...
    const imgline = `<img alt="id" src="images/fighter/wings/path/fname.png" class="hidden" style="position:absolute; z-index:zindex; top:tpos; left:lpos" />`
