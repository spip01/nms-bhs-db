...
const haulerBodiesMap = `
        <div id="map-hauler-bodies">
            ...
            <div id="map-selected"></div>
            <div id="map-hover"></div>
            <img id="map-transparent" src="images/blank.png" style="position:absolute" usemap="#hauler-bodies-map" />
...
const haulerWingsMap = `
        <div id="map-hauler-wings">
            ...
            <div id="map-selected"></div>
            <div id="map-hover"></div>
            <img id="map-transparent" src="images/blank.png" style="position:absolute" usemap="#hauler-wings-map" />
